            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{URL::asset('storage/handbags/'.$data['best']->first()->getImage()) }}"
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <p class="card-text">{{__('admin.texture')}} {{$data['best']->first()->getTexture() }}</
                                    </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('wishlist.add', ['id'=> $handbag->getId()]) }}"
                                ...
                                aria-pressed="true">{{__('handbag.wishlist')}}</a>
                            ...
                            <a href="{{ route('review.index', ['id'=> $handbag->getId()]) }}"
                                class="btn btn-primary m-1" role="button" aria-pressed="true">
                                {{__('review.rev')}}</a>
